  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-glow hover:shadow-elevated rounded-2xl",
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elevated hover:shadow-glow text-base rounded-2xl",
        "hero-secondary": "border-2 border-foreground/20 bg-card/80 backdrop-blur-sm text-foreground hover:bg-card hover:border-foreground/40 text-base rounded-2xl",
      },
      size: {
