      ...
      <div className="container relative z-10 pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-2xl">
            ...
            >
              Menu cards, thumbnails and short reels for food brands — crafted
              to sell and make mouths water.
            </motion.p>
          ...
          >
            <div className="relative">
              ...
              <div className="aspect-[3/5] rounded-3xl bg-gradient-to-br from-primary/20 to-accent/20 overflow-hidden shadow-elevated">
                <img
                  src="https://res.cloudinary.com/dbodkubbk/image/upload/v1765218593/Services_Providing_xtkst1.png"
                  alt="Beautiful restaurant menu design showcasing food photography"
              ...
              {/* Floating cards */}
              <motion.div
                className="absolute -bottom-6 -left-6 p-4 bg-card rounded-2xl shadow-elevated"
                animate={{
                  y: [0, -8, 0],
                }}
                transition={{
              ...
              <motion.div
                className="absolute -top-4 -right-4 p-4 bg-card rounded-2xl shadow-elevated"
                animate={{
                  y: [0, -6, 0],
                }}
                transition={{
