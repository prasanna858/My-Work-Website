...
const projects = [
  { id: 1, title: "Spice Garden Menu", category: "Menu", image: "/project-1.jpg", description: "Complete menu redesign for Indian restaurant" },
  { id: 2, title: "TasteBuds YouTube", category: "Thumbnails", image: "/project-2.jpg", description: "30 custom thumbnails for food channel" },
  { id: 3, title: "Fresh Bites Reels", category: "Reels", image: "/project-3.jpg", description: "Instagram reels series for cafe" },
  { id: 4, title: "Curry House Branding", category: "Brand Kit", image: "/project-4.jpg", description: "Complete brand identity package" },
  { id: 5, title: "Veg Paradise Menu", category: "Menu", image: "/project-5.jpg", description: "Vegetarian restaurant menu cards" },
  { id: 6, title: "Foodie Vlogs Thumbnails", category: "Thumbnails", image: "/project-6.jpg", description: "YouTube thumbnail series" },
  { id: 7, title: "Cafe Mocha Reels", category: "Reels", image: "/project-7.jpg", description: "Coffee shop promotional reels" },
  { id: 8, title: "Biryani House Menu", category: "Menu", image: "/project-8.jpg", description: "Traditional biryani restaurant menu" },
];
        ...
        <div className="container">
          ...
          >
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              A collection of menu designs, thumbnails, and visual content that drives results
            </p>
          </motion.div>
